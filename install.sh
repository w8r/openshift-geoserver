...
echo "Downloading Geoserver 2.6.3 from sourceforge.net..."
curl -L http://sourceforge.net/projects/geoserver/files/GeoServer/2.6.3/geoserver-2.6.3-war.zip > geoserver.zip
